...
Written for the person using the app, newest first. Each release is exactly one
kind — VERSION, CAPABILITY, or ITERATION — and the number is the triplet
`version.capability.iteration`. The service-worker cache name carries the same
triplet.
